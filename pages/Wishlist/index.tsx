                ...
                <BlueBackground>
                    <Row>
                        ...
                        <Col md={4} xs={12} className={styles.product_data}>
                            <h6 className="font-weight-bold text-white">Counter Strike</h6>
                        ...
                        <Col md={3} xs={12} className={styles.action}>
                            <strong className='text-white'>R$ 89,90</strong>

                            <div>
                                <StyledButton action={"Comprar"} icon={faCartPlus as IconProp} type_button="blue" />
                            </div>
                        </Col>
                    </Row>
                </BlueBackground>
